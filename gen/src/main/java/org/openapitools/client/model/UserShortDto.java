 ...
 */
@ApiModel(description = "Пользователь (краткая информация)")
...
public class UserShortDto {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "3", required = true, value = "Идентификатор")
   ...
   * @return name
  **/
  @ApiModelProperty(example = "Фёдоров Матвей", required = true, value = "Имя")
