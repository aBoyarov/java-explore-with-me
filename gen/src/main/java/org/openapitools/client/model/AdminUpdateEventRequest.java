 ...
 */
@ApiModel(description = "Информация для редактирования события администратором. Все поля необязательные. Значение полей не валидируется.")
...
public class AdminUpdateEventRequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "Новое краткое описание", value = "Краткое описание события")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "id категории к которой относится событие")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Новое полное описание", value = "Полное описание события")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2025-01-01 09:08:07", value = "Дата и время на которые намечено событие (в формате \"yyyy-MM-dd HH:mm:ss\")")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Нужно ли оплачивать участие в событии")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "33", value = "Ограничение на количество участников. Значение 0 - означает отсутствие ограничения")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "Нужна ли пре-модерация заявок на участие")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Новый заголовок", value = "Заголовок события")
