package exploreWithMeServer.page;
 ...
 */
public class PageLimit implements Pageable {
    private final int offset;
    private final int limit;
    private final Sort sort;

    protected PageLimit(int offset, int limit, Sort sort) {
        this.offset = offset;
        this.limit = limit;
        this.sort = sort;
    }
    ...
    public static Pageable of(Integer from, Integer size) {
        ...
        return new PageLimit(saveUnboxing(from), saveUnboxing(size), Sort.unsorted());
    }
    ...
    public static Pageable of(Integer from, Integer size, Sort sort) {
        ...
        validateOrThrowException(from, size);
        return new PageLimit(saveUnboxing(from), saveUnboxing(size), sort);
    }
